...
# OpenCV is *not* required to use the face_recognitiongnition library. It's only required if you want to run this
# specific demo. If you have trouble installing it, try any of the other demos that don't require it instead.

# Get a reference to webcam #0 (the default one)
# video_capture = cv2.VideoCapture(1)
# # video_capture = cv2.VideoCapture()
# # video_capture.open("rtsp://admin:12345@103.59.59.10:554/h264/ch7/main/av_stream")q
# time.sleep(2)
# vs = VideoStream(src=0).start()
vs = VideoStream(src="rtsp://admin:12345@103.59.59.10:554/h264/ch1/main/av_stream").start()
time.sleep(2)
...
paresh_image = face_recognition.load_image_file("paresh.jpg")
paresh_face_encoding = face_recognition.face_encodings(paresh_image)[0]
